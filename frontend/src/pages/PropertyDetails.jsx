...
const PropertyDetails = () => {
  ...
  const isOwner =
    loggedInUser &&
    property?.owner &&
    (loggedInUser.id === property.owner ||
      loggedInUser.id === property.owner?._id);
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            <div className="lg:text-right">
              <p className="text-[#B3CFE5] text-sm">Monthly Rent</p>
              ...
              <div className="flex items-center lg:justify-end mt-1">
                ...
                <span className="text-[#B3CFE5] ml-1">/month</span>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-5 -mt-20 relative z-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-3xl shadow-sm p-6 md:p-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                <div className="bg-[#F4F8FB] rounded-2xl p-4">
                  ...
                  <p className="text-xs text-gray-400 mt-3">Property Type</p>
                ...
                <div className="bg-[#F4F8FB] rounded-2xl p-4">
                  ...
                  <p className="text-xs text-gray-400 mt-3">Room Type</p>
                  <p className="font-bold text-[#0A1931] mt-1">
                    {property.roomType}
                  </p>
                </div>
                ...
                <div className="bg-[#F4F8FB] rounded-2xl p-4">
                  ...
                  <p className="text-xs text-gray-400 mt-3">Preferred For</p>
                  <p className="font-bold text-[#0A1931] mt-1">
                ...
                <div className="bg-[#F4F8FB] rounded-2xl p-4">
                  ...
                  <p className="text-xs text-gray-400 mt-3">Furnishing</p>
                  <p className="font-bold text-[#0A1931] mt-1">
            ...
            {/* AMENITIES */}
            <section className="bg-white rounded-3xl shadow-sm p-6 md:p-8">
              <h2 className="text-2xl font-bold text-[#0A1931]">Amenities</h2>
              ...
              {property.amenities?.length > 0 ? (
                ...
                <p className="text-gray-500 mt-4">No amenities specified.</p>
              )}
            </section>
              ...
              <div className="flex items-start gap-4 mt-6 bg-[#F4F8FB] rounded-2xl p-5">
                ...
                <div>
                  <p className="font-bold text-[#0A1931]">
                    {property.location?.area || "Area not specified"}
                  </p>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-6 sticky top-6">
              ...
              {isOwner && (
                <div className="border-t border-gray-100 mt-6 pt-5 space-y-3">
                  ...
                  <button
                    onClick={() => navigate(`/editProperty/${id}`)}
                    className="w-full bg-[#4A7FA7] hover:bg-[#3A6F97] text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-all duration-300"
                  >
                    <FaEdit />
                    Edit Property
                  </button>
                  ...
                  <button
                    ...
                    className={`w-full py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-all duration-300 ${
                      deleting
                        ...
                        : "bg-red-50 text-red-500 border border-red-200 hover:bg-red-500 hover:text-white hover:border-red-500"
                    }`}
                  >
                    <FaTrashAlt />
              ...
              <div className="bg-[#F4F8FB] rounded-xl p-4 mt-6 flex gap-3">
                ...
                <p className="text-xs text-gray-500 leading-5">
                  Never make payments before visiting the property and
                  verifying the owner details.
                </p>
              </div>
            </div>
          </div>
